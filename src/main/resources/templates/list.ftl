<div class="generic-container">
    ...
    <div class="panel panel-default">
        <div class="panel-heading"><span class="lead">Functions</span></div>
        <div class="panel-body">
		    <td><button id="asd11" type="button" ng-click="ctrl.testFun()" class="btn btn-success custom-width">Dosmth</button></td>
        </div>
    </div>
</div>