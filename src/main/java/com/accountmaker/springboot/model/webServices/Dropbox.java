...
public class Dropbox {
    ...
    public Dropbox(boolean isRandom) {
        if(isRandom) {
            ...
            this.birthdayMonth = Dropbox.Month.getRandomMonth().toString();
            this.birthdayDay = getRandomBirthday();
            this.birthdayYear = getRandomBirthYear();
            this.gender = Dropbox.Gender.getRandomGender().toString();
        }
    }
    ...
    public enum Gender {
        ...
        public static Dropbox.Gender getRandomGender() {
    ...
    public enum Month {
        ...
        public static Dropbox.Month getRandomMonth() {
            Random random = new Random();
            return values()[random.nextInt(values().length)];
        }
