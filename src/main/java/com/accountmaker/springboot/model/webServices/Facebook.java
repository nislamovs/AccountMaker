...
public class Facebook {
    ...
    public Facebook(boolean isRandom) {
        if(isRandom) {
            this.firstname = RandomStringUtils.randomAlphabetic(1).toUpperCase()+RandomStringUtils.randomAlphabetic(10).toLowerCase();
            this.lastname = RandomStringUtils.randomAlphabetic(1).toUpperCase()+RandomStringUtils.randomAlphabetic(6).toLowerCase();
            this.username = RandomStringUtils.randomAlphanumeric(15);
            this.password = RandomStringUtils.randomAlphanumeric(15);
            this.birthdayMonth = Facebook.Month.getRandomMonth().toString();
            this.birthdayDay = getRandomBirthday();
            this.birthdayYear = getRandomBirthYear();
            this.gender = Facebook.Gender.getRandomGender().toString();
        }
    }
    ...
    public enum Gender {
        ...
        public static Facebook.Gender getRandomGender() {
    ...
    public enum Month {
        ...
        public static Facebook.Month getRandomMonth() {
            Random random = new Random();
            return values()[random.nextInt(values().length)];
        }
