...
@Entity
@Table(name="github")
public @Data class Github implements Serializable{
    ...
    public Github(boolean isRandom) {
        if(isRandom) {
            ...
            this.birthdayMonth = Github.Month.getRandomMonth().toString();
            this.birthdayDay = getRandomBirthday();
            this.birthdayYear = getRandomBirthYear();
            this.gender = Github.Gender.getRandomGender().toString();
        }
    }
    ...
    public enum Gender {
        ...
        public static Github.Gender getRandomGender() {
    ...
    public enum Month {
        ...
        public static Github.Month getRandomMonth() {
            Random random = new Random();
            return values()[random.nextInt(values().length)];
        }
